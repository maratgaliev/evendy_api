describe Auth::SessionsController, type: :request do
  describe 'POST /users/sign_in' do
    ...
    let!(:user) { FactoryBot.create(:user, email: email, password: 'password', name: 'name', phone: '89033556128') }
    ...
    context 'invalid credentials' do
      ...
      its(:body) { is_expected.to eq '{"error":{"base":["Неверный email или пароль"]}}' }
    end
